...
function DoctorCitas() {
  ...
  const fetchDoctorCitas = useCallback(async () => {
    ...
    try {
      // Esta ruta ahora devuelve a.patient_id gracias a la corrección del backend
          ...
          <div className="citas-list">
            {citas.map(cita => (
              <div key={cita.id} className="cita-card">
                ...
                <p>
                  <strong>Hora:</strong>
                  {/* SOLUCIÓN FINAL: Extracción manual de hora UTC */}
                ...
                <button 
                  ...
                  // Ahora cita.patient_id SÍ existe gracias a la corrección del backend
