...
const promoImages = [
  'https://img.freepik.com/fotos-premium/medicina-sanitaria-trabajo-equipo-medico-enfermero-trabajadores-sanitarios-que-trabajan-equipo-hospital-colaboracion-medica-confianza-grupo-sanitario-trabajo-clinica-recibir-atencion_590464-89336.jpg',
  'https://img.freepik.com/fotos-premium/liderazgo-trabajo-equipo-retrato-medico-equipo-hospital-exito-apoyo-ayuda-trabajo-medico-medicos-enfermeras-o-empleados-atencion-medica-que-confian-bienestar-salud-medicina_590464-143213.jpg',
  'https://e0.pxfuel.com/wallpapers/209/483/desktop-wallpaper-medical-tourism-in-india-medical-tourism-company.jpg'
];
...
function GestionCitas() {
  ...
  // --- ¡NUEVO! Efecto para rotar las imágenes ---
  useEffect(() => {
    const timer = setInterval(() => {
      setCurrentImageIndex((prevIndex) =>
        prevIndex === promoImages.length - 1 ? 0 : prevIndex + 1
      );
    }, 2000); // Rota cada 2 segundos (2000ms)

    return () => clearInterval(timer); // Limpia el intervalo al desmontar
  }, []);

  // Carga la lista de médicos al iniciar
  useEffect(() => {
  ...
  // --- ¡NUEVA ESTRUCTURA JSX CON CONTENEDORES! ---
  return (
    <div className="gestion-citas-page">
      
      {/* --- Contenedor Principal (Izquierda) --- */}
      <main className="citas-main-content">
      ...
      <aside className="citas-sidebar-promo">
